    ...
    routeInit: function(config) {
      ...
      var routeOpts = {
        ...
        },
        {
          ...
          path: '/detail',
          component: 'views/detail.html',
          name: 'detail'
        },{
          path: '/addArticle',
          component: 'views/addArticle.html',
          name: 'addArticle'
        },{
          path: '/search',
          component: 'views/search.html',
          name: 'search'
        }]
      };
      if (config.loadType === 'TABS') {
